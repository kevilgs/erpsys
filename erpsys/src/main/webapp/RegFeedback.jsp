		...
		<div class="card">
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-center mb-4">
					...
					<a href="HomePage" class="btn btn-primary"> <i
						class="bi bi-house-fill"></i> Go to Home
					</a>
				</div>
				...
				<div class="alert alert-danger" role="alert">Failed to submit
				...
				<div class="table-responsive">
					<table class="table table-hover">
                        ...
                        %>
							<tr>
								<td colspan="4" class="text-center">No products available
									for feedback</td>
							</tr>
							<%
                        }
				...
				<form action="SubmitFeedback" method="POST" id="feedbackForm"
					...
					<div class="modal-body">
						...
						<div class="mb-3">
							...
							<div id="ratingError" class="text-danger d-none">Please
								select a rating</div>
						</div>
						...
						<div class="mb-3">
							...
							<div id="commentsError" class="text-danger d-none">Comments
								cannot be empty</div>
						</div>
					</div>
